...
- **Клиент (`src/client/`)**: Flutter-приложение Reciper (онбординг, план питания, рецепты, скан холодильника, профиль, cooking mode). В src/client/build/app/outputs/flutter-apk/app-release.apk находится собранный APK-файл.
- **Бэкенд (`src/backend/`)**: FastAPI AI-orchestrator для генерации плана питания, замены блюда, подбора/генерации рецептов и распознавания продуктов на фо
