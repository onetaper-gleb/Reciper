...
class FridgeScanService:
    ...
    def scan_fridge(
        ...
        system_prompt, user_prompt = self.prompt_builder.build_fridge_scan_prompt(existing_products)
        ai_text = self._gemini().generate_with_image(user_prompt, image_bytes, system_prompt)
